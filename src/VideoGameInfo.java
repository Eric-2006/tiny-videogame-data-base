public class VideoGameInfo {
    ...
    public  static final int SIZE = 2*TITLE_LIMIT + 2*SERIES_LIMIT + 2*PUBLISHER_LIMIT + 2 + 4;

    public VideoGameInfo (String title, String series, String publisher, short year, int sales) {
        this.title     = title;
        this.series    = series;
